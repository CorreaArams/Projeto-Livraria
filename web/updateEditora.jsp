    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form action="" method="post">
                ...
                String sql = "SELECT * FROM editora WHERE id ='"+num+"'";
                ...
                <form action="" method="post" class="needs-validation" novalidate>
                    ...
                    <div class="form-row">                
                        <div class="col mb-3">
                            ...
                            <input type="text" class="form-control" id="validationCustom02" name="cidade" value='<%=rs.getString("cidade")%>' placeholder="Cidade" required>
                            <div class="invalid-feedback">
                                Por favor, a cidade.
                            </div>
                        </div>
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="listaEditoras.jsp" class="btn btn-default botao2">Voltar</a>
                    </div>
                </form>
                ...
                <%
                    ...
                    String c = request.getParameter("cidade");
                 
                    if(a!=null && b!=null && c!=null){
                    String sql2 = "UPDATE editora SET nome=?, cidade=? WHERE id ='"+a+"'";
